...
\section{Equation 1}
\begin{dmath*}
\overline{\overline{\chi}}^{\eta}_{a b c d}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}+{j}_{c}+{j}_{d}} \* \sum_{{J}_{2}} \* (-1)^{{J}_{2}} \* \hatfact{{J}_{2}^{2}} \* \sixj{{j}_{d}}{{j}_{b}}{{J}_{0}}{{j}_{c}}{{j}_{a}}{{J}_{2}} \* \bar{\chi}^{\eta}_{a b c d}^{{J}_{2} {J}_{2} 0}
\end{dmath*}
