...
\section{Equation 1}
\begin{dmath*}
\bar{\chi}_{i j k l}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{1},{J}_{0}} \* \sum_{{J}_{2}} \* \hatfact{{J}_{2}^{2}} \* \sixj{{j}_{j}}{{j}_{k}}{{J}_{0}}{{j}_{l}}{{j}_{i}}{{J}_{2}} \* \chi_{i j k l}^{{J}_{2} {J}_{2} 0}
\end{dmath*}

\section{Equation 2}
\begin{dmath*}
\overline{\overline{\chi}}_{i j k l}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{0},{J}_{1}} \* (-1)^{{j}_{k}+{j}_{l}} \* \sum_{{J}_{2}} \* (-1)^{{J}_{2}} \* \hatfact{{J}_{2}^{2}} \* \sixj{{j}_{j}}{{j}_{l}}{{J}_{1}}{{j}_{k}}{{j}_{i}}{{J}_{2}} \* \chi_{i j k l}^{{J}_{2} {J}_{2} 0}
\end{dmath*}
