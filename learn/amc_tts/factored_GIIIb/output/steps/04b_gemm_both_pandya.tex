...
\section{Equation 1}
\begin{dmath*}
W_{j l i k}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* \sum_{a b {J}_{2} {J}_{3} {J}_{4}} \* \hatfact{{J}_{2}^{2}} \* \hatfact{{J}_{3}^{2}} \* \hatfact{{J}_{4}^{2}} \* \sixj{{j}_{l}}{{j}_{j}}{{J}_{4}}{{j}_{b}}{{j}_{a}}{{J}_{2}} \* \sixj{{j}_{k}}{{j}_{i}}{{J}_{4}}{{j}_{b}}{{j}_{a}}{{J}_{3}} \* \sixj{{j}_{l}}{{j}_{i}}{{J}_{0}}{{j}_{k}}{{j}_{j}}{{J}_{4}} \* \bar{\Gamma}_{j l a b}^{{J}_{2} {J}_{2} 0} \* \bar{\chi}^{\eta}_{a b i k}^{{J}_{3} {J}_{3} 0}
\end{dmath*}
