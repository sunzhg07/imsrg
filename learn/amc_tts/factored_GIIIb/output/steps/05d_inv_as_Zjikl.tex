...
\section{Equation 1}
\begin{dmath*}
Z_{j i k l}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}+{j}_{i}+{j}_{j}} \* \sum_{{J}_{2}} \* \hatfact{{J}_{2}^{2}} \* \sixj{{j}_{l}}{{j}_{k}}{{J}_{0}}{{j}_{j}}{{j}_{i}}{{J}_{2}} \* W_{i j k l}^{{J}_{2} {J}_{2} 0}
\end{dmath*}
