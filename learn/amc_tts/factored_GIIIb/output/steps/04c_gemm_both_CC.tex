...
\section{Equation 1}
\begin{dmath*}
W_{j l i k}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}+{j}_{i}+{j}_{j}+{j}_{k}+{j}_{l}} \* \sum_{a b {J}_{2} {J}_{3}} \* (-1)^{{J}_{2}+{J}_{3}} \* \hatfact{{J}_{2}^{2}} \* \hatfact{{J}_{3}^{2}} \* \sixj{{J}_{0}}{{J}_{2}}{{J}_{3}}{{j}_{a}}{{j}_{i}}{{j}_{j}} \* \sixj{{J}_{2}}{{J}_{3}}{{J}_{0}}{{j}_{k}}{{j}_{l}}{{j}_{b}} \* \bar{\Gamma}_{j l a b}^{{J}_{2} {J}_{2} 0} \* \overline{\overline{\chi}}^{\eta}_{a b i k}^{{J}_{3} {J}_{3} 0}
\end{dmath*}
