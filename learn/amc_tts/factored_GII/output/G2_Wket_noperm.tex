...
\section{Equation 1}
\begin{dmath*}
V_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{j}_{l}} \* \hatfact{{J}_{0}^{-1}} \* \sum_{a {J}_{2} {{\lambda}}_{0}} \* (-1)^{{J}_{2}+{j}_{a}} \* \hatfact{{J}_{2}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{J}_{0}}{{J}_{2}}{{{\lambda}}_{0}}{{j}_{a}}{{j}_{k}}{{j}_{l}} \* \chi^{\zeta}_{a k}^{{{\lambda}}_{0}} \* \Omega_{i j a l}^{{J}_{0} {J}_{2} {{\lambda}}_{0}}
\end{dmath*}
