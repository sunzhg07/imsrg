...
\section{Equation 1}
\begin{dmath*}
\chi^{\zeta}_{i j}^{{{\lambda}}_{0}} = \frac{1}{2} \* (-1)^{{j}_{j}+{{\lambda}}_{0}} \* \sum_{0 a b c {J}_{0} {J}_{1}} \* (n_{a} \* n_{b} \* \bar{n}_{c} + \bar{n}_{a} \* \bar{n}_{b} \* n_{c}) \* (-1)^{{J}_{0}+{j}_{a}} \* \hatfact{{J}_{1}} \* \sixj{{{\lambda}}_{0}}{{J}_{1}}{{J}_{0}}{{j}_{a}}{{j}_{i}}{{j}_{j}} \* \Gamma_{a i b c}^{{J}_{0} {J}_{0} 0} \* \Omega_{b c a j}^{{J}_{0} {J}_{1} {{\lambda}}_{0}}
\end{dmath*}
