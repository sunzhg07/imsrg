...
\section{Equation 1}
\begin{dmath*}
W_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{j}_{i}} \* \hatfact{{J}_{0}^{-1}} \* \sum_{a {J}_{2} {{\lambda}}_{0}} \* (-1)^{{J}_{2}+{j}_{a}} \* \hatfact{{J}_{2}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{J}_{0}}{{J}_{2}}{{{\lambda}}_{0}}{{j}_{a}}{{j}_{j}}{{j}_{i}} \* \chi^{\zeta}_{j a}^{{{\lambda}}_{0}} \* \Omega_{i a k l}^{{J}_{2} {J}_{0} {{\lambda}}_{0}}
\end{dmath*}
