...
\section{Equation 1}
\begin{dmath*}
f^{(II)}_b_{i j}^{0} = \frac{1}{2} \* \delta_{{j}_{j},{j}_{i}} \* (-1)^{{j}_{i}} \* \hatfact{{j}_{i}^{-1}} \* \sum_{a b c d e {J}_{0} {J}_{1} {J}_{2} {J}_{3} {J}_{4}} \* (n_{a} \* n_{b} \* \bar{n}_{c} \* \bar{n}_{e} -\bar{n}_{a} \* \bar{n}_{b} \* n_{c} \* n_{e}) \* (-1)^{{J}_{0}+{J}_{2}+{J}_{4}+{j}_{c}+{j}_{d}+{j}_{e}} \* \hatfact{{J}_{1}} \* \hatfact{{J}_{2}^{-1}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \sixj{{J}_{2}}{{J}_{1}}{{J}_{0}}{{j}_{c}}{{j}_{d}}{{j}_{e}} \* \sixj{{J}_{4}}{{J}_{2}}{{J}_{3}}{{j}_{e}}{{j}_{i}}{{j}_{d}} \* \Gamma_{c d a b}^{{J}_{0} {J}_{0} 0} \* \Omega_{a b c e}^{{J}_{0} {J}_{1} {J}_{2}} \* \Omega_{e j d i}^{{J}_{3} {J}_{4} {J}_{2}}
\end{dmath*}
