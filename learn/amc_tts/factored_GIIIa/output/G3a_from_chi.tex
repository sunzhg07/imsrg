...
\subsection{Term 3}
\begin{dmath*}
-\delta_{{J}_{1},{J}_{0}} \* \sum_{a b} \* \Gamma_{i j a b}^{{J}_{0} {J}_{0} 0} \* \chi^{\eta}_{k l a b}^{{J}_{0} {J}_{0} 0}
\end{dmath*}
\subsection{Term 4}
\begin{dmath*}
\delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}+{j}_{k}+{j}_{l}} \* \sum_{a b} \* \Gamma_{i j a b}^{{J}_{0} {J}_{0} 0} \* \chi^{\eta}_{l k a b}^{{J}_{0} {J}_{0} 0}
\end{dmath*}
