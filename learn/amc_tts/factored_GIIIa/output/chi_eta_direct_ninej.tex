...
\section{Equation 1}
\begin{dmath*}
\chi^{\eta}_{i j k l}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{1},{J}_{0}} \* (-1)^{{j}_{i}+{j}_{k}} \* \hatfact{{J}_{0}} \* \sum_{a b {J}_{2} {J}_{3} {J}_{4} {J}_{5} {j}_{0} {{\lambda}}_{0}} \* (\bar{n}_{a} \* n_{b} \* \bar{n}_{k} + n_{a} \* \bar{n}_{b} \* n_{k}) \* (-1)^{{J}_{2}+{J}_{4}+{{\lambda}}_{0}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \hatfact{{J}_{5}} \* \hatfact{{j}_{0}^{2}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{J}_{3}}{{{\lambda}}_{0}}{{J}_{2}}{{j}_{a}}{{j}_{i}}{{j}_{0}} \* \sixj{{J}_{4}}{{{\lambda}}_{0}}{{J}_{5}}{{j}_{a}}{{j}_{k}}{{j}_{0}} \* \ninej{{j}_{l}}{{j}_{b}}{{J}_{3}}{{j}_{k}}{{J}_{4}}{{j}_{0}}{{J}_{0}}{{j}_{j}}{{j}_{i}} \* \Omega_{i a b l}^{{J}_{2} {J}_{3} {{\lambda}}_{0}} \* \Omega_{b j k a}^{{J}_{4} {J}_{5} {{\lambda}}_{0}}
\end{dmath*}
