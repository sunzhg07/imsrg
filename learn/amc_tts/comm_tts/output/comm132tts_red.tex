...
\section{Equation 1}
\begin{dmath*}
Z_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}} \* \hatfact{{J}_{0}^{-1}} \* \sum_{a b {j}_{0} {j}_{1} {{\lambda}}_{0}} \* (n_{a} -n_{b}) \* (-1)^{{j}_{b}+{j}_{0}} \* \hatfact{{j}_{0}} \* \hatfact{{j}_{1}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{j}_{a}}{{j}_{b}}{{{\lambda}}_{0}}{{j}_{0}}{{j}_{1}}{{J}_{0}} \* X_{a b}^{{{\lambda}}_{0}} \* Y_{i j b k l a}^{{J}_{0} {j}_{0} {J}_{0} {j}_{1} {{\lambda}}_{0}}
\end{dmath*}

\section{Equation 2}
\begin{dmath*}
Z_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}} \* \hatfact{{J}_{0}^{-1}} \* \sum_{a b {j}_{0} {j}_{1} {{\lambda}}_{0}} \* (n_{a} -n_{b}) \* (-1)^{{j}_{b}+{j}_{0}} \* \hatfact{{j}_{0}} \* \hatfact{{j}_{1}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{j}_{a}}{{j}_{b}}{{{\lambda}}_{0}}{{j}_{0}}{{j}_{1}}{{J}_{0}} \* Y_{a b}^{{{\lambda}}_{0}} \* X_{i j b k l a}^{{J}_{0} {j}_{0} {J}_{0} {j}_{1} {{\lambda}}_{0}}
\end{dmath*}
