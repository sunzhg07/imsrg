...
\section{Equation 1}
\begin{dmath*}
\chi^{\theta}_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}} \* \hatfact{{J}_{0}^{-1}} \* \sum_{a b {J}_{2} {{\lambda}}_{0}} \* (n_{a} \* n_{b} \* \bar{n}_{k} + \bar{n}_{a} \* \bar{n}_{b} \* n_{k} + n_{a} \* n_{b} \* \bar{n}_{j} + \bar{n}_{a} \* \bar{n}_{b} \* n_{j}) \* (-1)^{{J}_{2}+{{\lambda}}_{0}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \Omega_{i j a b}^{{J}_{0} {J}_{2} {{\lambda}}_{0}} \* \Omega_{a b k l}^{{J}_{2} {J}_{0} {{\lambda}}_{0}}
\end{dmath*}
