...
\section{Equation 1}
\begin{dmath*}
\overline{\overline{\chi}}^{\iota}_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{J}_{0}+{J}_{1}+{j}_{i}+{j}_{j}+{j}_{k}+{j}_{l}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{{J}_{2} {J}_{3}} \* (-1)^{{J}_{2}+{J}_{3}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \ninej{{{\lambda}}_{0}}{{J}_{0}}{{J}_{1}}{{J}_{3}}{{j}_{k}}{{j}_{j}}{{J}_{2}}{{j}_{i}}{{j}_{l}} \* \bar{\chi}^{\iota}_{i j k l}^{{J}_{2} {J}_{3} {{\lambda}}_{0}}
\end{dmath*}
