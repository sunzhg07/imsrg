...
\subsection{Term 1}
\begin{dmath*}
\hatfact{{J}_{0}^{-1}} \* \sum_{0 a b} \* (\bar{n}_{a} \* \bar{n}_{b} \* n_{l} + n_{a} \* n_{b} \* \bar{n}_{l}) \* \Gamma_{i j a b}^{{J}_{0} {J}_{0} 0} \* \Omega_{a b k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}}
\end{dmath*}
\subsection{Term 2}
\begin{dmath*}
\hatfact{{J}_{1}^{-1}} \* \sum_{0 a b} \* (\bar{n}_{a} \* \bar{n}_{b} \* n_{j} + n_{a} \* n_{b} \* \bar{n}_{j}) \* \Omega_{i j a b}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} \* \Gamma_{a b k l}^{{J}_{1} {J}_{1} 0}
\end{dmath*}
