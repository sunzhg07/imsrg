...
\section{Equation 1}
\begin{dmath*}
\chi^{\kappa}_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = -(-1)^{{J}_{0}+{J}_{1}+{j}_{i}+{j}_{k}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{0 a b {J}_{2} {J}_{3}} \* (\bar{n}_{a} \* n_{b} \* n_{k} + n_{a} \* \bar{n}_{b} \* \bar{n}_{k}) \* (-1)^{{J}_{2}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \ninej{{{\lambda}}_{0}}{{J}_{0}}{{J}_{1}}{{J}_{3}}{{j}_{j}}{{j}_{l}}{{J}_{2}}{{j}_{i}}{{j}_{k}} \* \bar{\Gamma}_{i b a k}^{{J}_{2} {J}_{2} 0} \* \bar{\Omega}_{a j l b}^{{J}_{2} {J}_{3} {{\lambda}}_{0}}
\end{dmath*}
