...
\section{Equation 1}
\begin{dmath*}
W_{k l i j}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}} \* \hatfact{{J}_{0}^{-1}} \* \sum_{b d {J}_{2} {{\lambda}}_{0}} \* (-1)^{{j}_{b}+{j}_{d}+{{\lambda}}_{0}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \chi^{\kappa}_{k l b d}^{{J}_{0} {J}_{2} {{\lambda}}_{0}} \* \Omega_{d b i j}^{{J}_{2} {J}_{0} {{\lambda}}_{0}}
\end{dmath*}
