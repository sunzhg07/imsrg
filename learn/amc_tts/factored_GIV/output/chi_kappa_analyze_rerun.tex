...
\section{Equation 1}
\begin{dmath*}
\chi^{\kappa}_{i j b d}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = -(-1)^{{J}_{1}+{j}_{i}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{0 a c {J}_{2} {J}_{3} {J}_{4} {J}_{5} {j}_{0}} \* (\bar{n}_{c} \* \bar{n}_{d} \* n_{a} + n_{c} \* n_{d} \* \bar{n}_{a}) \* (-1)^{{J}_{2}+{J}_{3}+{J}_{4}+{j}_{c}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}^{2}} \* \hatfact{{J}_{5}^{2}} \* \hatfact{{j}_{0}^{2}} \* \sixj{{J}_{3}}{{{\lambda}}_{0}}{{J}_{2}}{{j}_{i}}{{j}_{a}}{{j}_{0}} \* \sixj{{J}_{1}}{{{\lambda}}_{0}}{{J}_{0}}{{j}_{i}}{{j}_{j}}{{j}_{0}} \* \sixj{{j}_{a}}{{j}_{c}}{{J}_{5}}{{j}_{d}}{{j}_{0}}{{J}_{3}} \* \sixj{{j}_{b}}{{j}_{j}}{{J}_{5}}{{j}_{c}}{{j}_{a}}{{J}_{4}} \* \sixj{{j}_{d}}{{j}_{b}}{{J}_{1}}{{j}_{j}}{{j}_{0}}{{J}_{5}} \* \Omega_{a i c d}^{{J}_{2} {J}_{3} {{\lambda}}_{0}} \* \Gamma_{j c b a}^{{J}_{4} {J}_{4} 0}
\end{dmath*}
