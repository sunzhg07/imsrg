...
\section{Equation 1}
\begin{dmath*}
W^{\mathrm{IV_b}}_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{J}_{0}+{J}_{1}+{j}_{i}+{j}_{k}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{{J}_{2} {J}_{3} {j}_{0}} \* (-1)^{{J}_{2}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{j}_{0}^{2}} \* \sixj{{{\lambda}}_{0}}{{J}_{3}}{{J}_{2}}{{j}_{i}}{{j}_{k}}{{j}_{0}} \* \sixj{{j}_{i}}{{j}_{j}}{{J}_{0}}{{j}_{l}}{{j}_{0}}{{J}_{3}} \* \sixj{{J}_{1}}{{J}_{0}}{{{\lambda}}_{0}}{{j}_{0}}{{j}_{k}}{{j}_{l}} \* W_{i j k l}^{{J}_{2} {J}_{3} {{\lambda}}_{0}}
\end{dmath*}
