...
\section{Equation 1}
\begin{dmath*}
W^{\mathrm{IV_b}}_{j l i k}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{J}_{1}+{j}_{i}+{j}_{j}+{j}_{k}+{j}_{l}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \hatfact{{{\lambda}}_{0}} \* \sum_{a b {J}_{2} {J}_{3} {J}_{4} {J}_{5} {J}_{6} {{\lambda}}_{1} {{\lambda}}_{2}} \* (-1)^{{J}_{2}+{J}_{4}+{{\lambda}}_{1}+{{\lambda}}_{2}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \hatfact{{J}_{5}} \* \hatfact{{J}_{6}^{2}} \* \sixj{{J}_{0}}{{J}_{2}}{{J}_{4}}{{j}_{a}}{{j}_{i}}{{j}_{j}} \* \sixj{{J}_{1}}{{J}_{3}}{{J}_{5}}{{j}_{b}}{{j}_{k}}{{j}_{l}} \* \sixj{{J}_{0}}{{{\lambda}}_{1}}{{J}_{6}}{{J}_{3}}{{J}_{4}}{{J}_{2}} \* \sixj{{{\lambda}}_{2}}{{J}_{1}}{{J}_{6}}{{J}_{3}}{{J}_{4}}{{J}_{5}} \* \sixj{{{\lambda}}_{0}}{{{\lambda}}_{1}}{{{\lambda}}_{2}}{{J}_{6}}{{J}_{1}}{{J}_{0}} \* \overline{\overline{\Omega}}_{j l a b}^{{J}_{2} {J}_{3} {{\lambda}}_{1}} \* \overline{\overline{\chi}}^{\iota}_{a b i k}^{{J}_{4} {J}_{5} {{\lambda}}_{2}}
\end{dmath*}
