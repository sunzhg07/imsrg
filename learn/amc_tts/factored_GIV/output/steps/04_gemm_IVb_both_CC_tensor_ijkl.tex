...
\section{Equation 1}
\begin{dmath*}
D_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{J}_{0}+{J}_{1}+{j}_{i}+{j}_{j}+{j}_{k}+{j}_{l}} \* \hatfact{{{\lambda}}_{0}} \* \sum_{a b {J}_{2} {{\lambda}}_{1} {{\lambda}}_{2}} \* \sixj{{{\lambda}}_{0}}{{{\lambda}}_{1}}{{{\lambda}}_{2}}{{J}_{2}}{{J}_{0}}{{J}_{1}} \* \overline{\overline{\Omega}}_{j b l a}^{{J}_{1} {J}_{2} {{\lambda}}_{1}} \* \overline{\overline{\chi}}^{\iota}_{a i b k}^{{J}_{2} {J}_{0} {{\lambda}}_{2}}
\end{dmath*}
