...
\section{Equation 1}
\begin{dmath*}
f^{(II)}_b_{i j}^{0} = \delta_{{j}_{j},{j}_{i}} \* (-1)^{{j}_{i}} \* \hatfact{{j}_{i}^{-2}} \* \sum_{d e {J}_{0} {J}_{1} {{\lambda}}_{0}} \* (-1)^{{J}_{1}+{j}_{d}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{J}_{1}}{{{\lambda}}_{0}}{{J}_{0}}{{j}_{e}}{{j}_{i}}{{j}_{d}} \* \chi^{\beta}_{d e}^{{{\lambda}}_{0}} \* \Omega_{e j d i}^{{J}_{0} {J}_{1} {{\lambda}}_{0}}
\end{dmath*}
