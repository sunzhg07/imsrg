...
\section{Equation 1}
\begin{dmath*}
\chi^{\gamma}_{i j k l}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{1},{J}_{0}} \* (-1)^{{j}_{j}+{j}_{l}} \* \hatfact{{J}_{0}} \* \sum_{a b {J}_{2} {J}_{3} {J}_{4} {J}_{5} {j}_{0} {{\lambda}}_{0}} \* (n_{a} \* \bar{n}_{b} \* n_{j} \* \bar{n}_{k} -\bar{n}_{a} \* n_{b} \* \bar{n}_{j} \* n_{k}) \* (-1)^{{J}_{3}+{J}_{5}+{{\lambda}}_{0}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \hatfact{{J}_{5}} \* \hatfact{{j}_{0}^{2}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{J}_{3}}{{{\lambda}}_{0}}{{J}_{2}}{{j}_{a}}{{j}_{j}}{{j}_{0}} \* \sixj{{J}_{4}}{{{\lambda}}_{0}}{{J}_{5}}{{j}_{a}}{{j}_{l}}{{j}_{0}} \* \ninej{{j}_{k}}{{j}_{b}}{{J}_{3}}{{j}_{l}}{{J}_{4}}{{j}_{0}}{{J}_{0}}{{j}_{i}}{{j}_{j}} \* \Omega_{a j k b}^{{J}_{2} {J}_{3} {{\lambda}}_{0}} \* \Omega_{i b a l}^{{J}_{4} {J}_{5} {{\lambda}}_{0}}
\end{dmath*}
