...
\section{Equation 1}
\begin{dmath*}
\chi_{a b c d}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{J}_{0}+{J}_{1}+{{\lambda}}_{0}} \* \hatfact{{{\lambda}}_{0}} \* \sum_{e f {J}_{2} {{\lambda}}_{1} {{\lambda}}_{2}} \* \sixj{{{\lambda}}_{0}}{{{\lambda}}_{1}}{{{\lambda}}_{2}}{{J}_{2}}{{J}_{1}}{{J}_{0}} \* \Omega_{a b e f}^{{J}_{0} {J}_{2} {{\lambda}}_{1}} \* \Omega_{e f c d}^{{J}_{2} {J}_{1} {{\lambda}}_{2}}
\end{dmath*}
