...
\section{Equation 1}
\begin{dmath*}
\chi_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = -(-1)^{{J}_{1}+{j}_{j}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{0 a b {J}_{2} {J}_{3} {J}_{4} {J}_{5} {j}_{0}} \* (-1)^{{J}_{3}+{j}_{b}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \hatfact{{J}_{5}^{2}} \* \hatfact{{j}_{0}^{2}} \* \sixj{{J}_{3}}{{{\lambda}}_{0}}{{J}_{2}}{{j}_{i}}{{j}_{b}}{{j}_{0}} \* \sixj{{J}_{1}}{{{\lambda}}_{0}}{{J}_{0}}{{j}_{i}}{{j}_{j}}{{j}_{0}} \* \sixj{{j}_{b}}{{j}_{a}}{{J}_{5}}{{j}_{l}}{{j}_{0}}{{J}_{3}} \* \sixj{{j}_{k}}{{j}_{j}}{{J}_{5}}{{j}_{a}}{{j}_{b}}{{J}_{4}} \* \sixj{{j}_{l}}{{j}_{k}}{{J}_{1}}{{j}_{j}}{{j}_{0}}{{J}_{5}} \* \Omega^{(1)}_{i b a l}^{{J}_{2} {J}_{3} {{\lambda}}_{0}} \* \Omega^{(2)}_{a j k b}^{{J}_{4} {J}_{4} 0}
\end{dmath*}
