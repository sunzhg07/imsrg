...
\section{Equation 2}
\begin{dmath*}
\bar{\chi}^{\gamma}_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* (-1)^{{J}_{0}} \* \hatfact{{J}_{0}^{-2}} \* \sum_{a b {J}_{2} {{\lambda}}_{0}} \* (n_{a} \* \bar{n}_{b} \* n_{j} \* \bar{n}_{k} -\bar{n}_{a} \* n_{b} \* \bar{n}_{j} \* n_{k}) \* (-1)^{{J}_{2}+{{\lambda}}_{0}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \bar{\Omega}_{a j k b}^{{J}_{2} {J}_{0} {{\lambda}}_{0}} \* \bar{\Omega}_{i b a l}^{{J}_{0} {J}_{2} {{\lambda}}_{0}}
\end{dmath*}
