...
\section{Equation 1}
\begin{dmath*}
\chi_{i j k l}^{{J}_{0} {J}_{1} 0} = \delta_{{J}_{1},{J}_{0}} \* \hatfact{{J}_{0}} \* \sum_{a b {J}_{2} {J}_{3}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \ninej{{j}_{i}}{{j}_{b}}{{J}_{2}}{{j}_{j}}{{J}_{3}}{{j}_{a}}{{J}_{0}}{{j}_{k}}{{j}_{l}} \* \Omega^{(1)}_{i b a l}^{{J}_{2} {J}_{2} 0} \* \Omega^{(2)}_{a j k b}^{{J}_{3} {J}_{3} 0}
\end{dmath*}
