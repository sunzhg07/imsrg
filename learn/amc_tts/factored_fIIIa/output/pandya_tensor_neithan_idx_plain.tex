...
\section{Equation 1}
\begin{dmath*}
\bar{T}_{p q r s}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{J}_{0}+{j}_{p}+{j}_{r}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{{J}_{2} {J}_{3} {j}_{0}} \* (-1)^{{J}_{2}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{j}_{0}^{2}} \* \sixj{{{\lambda}}_{0}}{{J}_{3}}{{J}_{2}}{{j}_{p}}{{j}_{s}}{{j}_{0}} \* \sixj{{j}_{p}}{{j}_{q}}{{J}_{0}}{{j}_{r}}{{j}_{0}}{{J}_{3}} \* \sixj{{J}_{1}}{{J}_{0}}{{{\lambda}}_{0}}{{j}_{0}}{{j}_{s}}{{j}_{r}} \* T_{p s r q}^{{J}_{2} {J}_{3} {{\lambda}}_{0}}
\end{dmath*}
