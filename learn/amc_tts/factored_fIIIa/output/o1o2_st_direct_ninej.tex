...
\section{Equation 1}
\begin{dmath*}
\chi_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = (-1)^{{j}_{i}+{j}_{j}+{j}_{k}+{j}_{l}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{0 a b {J}_{2} {J}_{3} {J}_{4} {J}_{5}} \* (-1)^{{J}_{2}+{J}_{5}+{j}_{a}+{j}_{b}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \hatfact{{J}_{5}^{2}} \* \sixj{{j}_{l}}{{j}_{b}}{{J}_{5}}{{j}_{i}}{{j}_{a}}{{J}_{2}} \* \sixj{{J}_{3}}{{J}_{0}}{{J}_{5}}{{j}_{i}}{{j}_{a}}{{j}_{j}} \* \sixj{{J}_{1}}{{J}_{5}}{{J}_{4}}{{j}_{b}}{{j}_{k}}{{j}_{l}} \* \sixj{{{\lambda}}_{0}}{{J}_{0}}{{J}_{1}}{{J}_{5}}{{J}_{4}}{{J}_{3}} \* \Omega^{(1)}_{i b a l}^{{J}_{2} {J}_{2} 0} \* \Omega^{(2)}_{a j k b}^{{J}_{3} {J}_{4} {{\lambda}}_{0}}
\end{dmath*}
