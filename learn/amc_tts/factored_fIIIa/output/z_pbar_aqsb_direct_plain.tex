...
\section{Equation 1}
\begin{dmath*}
Z_{p q s r}^{{J}_{0} {J}_{1} 0} = -\delta_{{J}_{1},{J}_{0}} \* (-1)^{{j}_{p}+{j}_{s}} \* \hatfact{{J}_{0}} \* \sum_{a b {J}_{2} {J}_{3} {J}_{4} {J}_{5} {J}_{6} {j}_{0} {{\lambda}}_{0}} \* (-1)^{{J}_{2}+{J}_{4}+{{\lambda}}_{0}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \hatfact{{J}_{4}} \* \hatfact{{J}_{5}} \* \hatfact{{J}_{6}^{2}} \* \hatfact{{j}_{0}^{2}} \* \hatfact{{{\lambda}}_{0}^{-1}} \* \sixj{{J}_{3}}{{{\lambda}}_{0}}{{J}_{2}}{{j}_{b}}{{j}_{p}}{{j}_{0}} \* \sixj{{J}_{4}}{{{\lambda}}_{0}}{{J}_{5}}{{j}_{b}}{{j}_{s}}{{j}_{0}} \* \sixj{{j}_{p}}{{j}_{r}}{{J}_{6}}{{j}_{a}}{{j}_{0}}{{J}_{3}} \* \sixj{{j}_{s}}{{j}_{q}}{{J}_{6}}{{j}_{a}}{{j}_{0}}{{J}_{4}} \* \sixj{{j}_{r}}{{j}_{s}}{{J}_{0}}{{j}_{q}}{{j}_{p}}{{J}_{6}} \* \Omega_{p b a r}^{{J}_{2} {J}_{3} {{\lambda}}_{0}} \* \Omega_{a q s b}^{{J}_{4} {J}_{5} {{\lambda}}_{0}}
\end{dmath*}
