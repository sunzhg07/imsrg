...
\section{Equation 1}
\begin{dmath*}
Y_{i j k l}^{{J}_{0} {J}_{1} {{\lambda}}_{0}} = -(-1)^{{J}_{0}+{j}_{i}+{j}_{k}+{{\lambda}}_{0}} \* \hatfact{{J}_{0}} \* \hatfact{{J}_{1}} \* \sum_{{J}_{2} {J}_{3}} \* (-1)^{{J}_{2}} \* \hatfact{{J}_{2}} \* \hatfact{{J}_{3}} \* \ninej{{{\lambda}}_{0}}{{J}_{0}}{{J}_{1}}{{J}_{3}}{{j}_{j}}{{j}_{k}}{{J}_{2}}{{j}_{i}}{{j}_{l}} \* \bar{Y}_{i j k l}^{{J}_{2} {J}_{3} {{\lambda}}_{0}}
\end{dmath*}
