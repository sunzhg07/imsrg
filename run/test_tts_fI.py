#!/usr/bin/env python3
"""Benchmark ethS factorized f^I (chi^alpha) vs unfactorized TTS reference."""
...
# Unfactorized TTS f^I only
ReferenceImplementations.comm223_231_tts_fI(Eta, Gamma, Z_ref)

# Factorized ethS: chi1b only (f^I); disable f^II and 2b intermediates
cm = Commutator
...
cm.FactorizedDoubleCommutator_eths.SetUse_TypeI_1b(True)
