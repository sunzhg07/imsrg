#!/usr/bin/env python3
"""Benchmark ethS factorized f^II (chi^beta tensor) vs unfactorized TTS reference."""
...
# Unfactorized TTS f^II only
ReferenceImplementations.comm223_231_tts_fII(Eta, Gamma, Z_ref)

# Factorized ethS: chi1b f^II only (tensor chi^beta); disable f^I / III / 2b
cm = Commutator
...
cm.FactorizedDoubleCommutator_eths.SetUse_TypeII_1b(True)
