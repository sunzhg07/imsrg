...
ref = 'Be8'     # reference used for normal ordering  // Ne20 , particial filling
val = 'p-shell' # valence space  // ne20 sd or 0hw// define off-diagonal in VS-SRG
...
## phase 1, read in interaction and decouple
...
if(phase == 1):
    ...
    # we want to out put fci interaction for benchmark
    
    
    
    rw.WriteTokyo( Hs, fci_fname,'')
if(phase ==2):
